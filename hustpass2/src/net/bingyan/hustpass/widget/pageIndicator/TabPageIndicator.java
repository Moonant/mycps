 ...
 */
package net.bingyan.hustpass.widget.pageIndicator;
...
public class TabPageIndicator extends HorizontalScrollView implements
		PageIndicator {
	String TAG = "TabPageIndicator";
	int id;
	int[] tabAttrs = { R.attr.vpiTabPageIndicatorStyle,
			R.attr.vpiTabPageIndicatorStyleNobg,
			R.attr.vpiTabPageIndicatorStyleBgYellow };
	...
	public TabPageIndicator(Context context, AttributeSet attrs) {
		...
		id = a.getInt(R.styleable.TabPageIndicator_tabAttr,
				0);
	...
	private class TabView extends TextView {
		...
		public TabView(Context context) {
			super(context, null, tabAttrs[id]);
		}
